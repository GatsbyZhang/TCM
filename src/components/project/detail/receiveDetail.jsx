...
export default class Detail extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Modal title="收货单位详情" visible={this.props.visible} className="delivery-dialog"
                ...
                >
                    <form action="###" className="delivery-form">
                        ...
                        <Address oDiv="receive-map" itudeId="receive-longitude" positionId="receive-position"/>
                        <div>
                            <label>审核状态：</label>
                            <select name="state">
                        ...
                        <div className="examine">
                            <label>审核资质：</label>
                            <div>
                                <img src="/static/img/3220973acdbfa52d60d3ca1ded76c96c.jpg"/>
                                营业执照
                            </div>
                            <div>
                                <img src="/static/img/3220973acdbfa52d60d3ca1ded76c96c.jpg"/>
                        ...
                        <div>
                            ...
                            <label>收货单位数：</label><input name="getUnits" type="text" value="dsadsa"/>
