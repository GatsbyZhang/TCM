...
export  default class OptionCompact extends Component {
    componentDidMount() {
        $("#optionCompact-list").jqGrid(
            {
                ...
                colModel: [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
                    ...
                    {
                        name: 'cancel', index: 'cancel', width: "15%", align: "center", formatter: function (obj) {
                        if(obj){
                ...
                rowNum: 20,//一页显示多少条
                pgtext: '第{0}页   共 {1} 页',
                pager: '#optionCompact-page',//表格页脚的占位符(一般是div)的id
                sortname: 'name',//初始化的时候排序的字段
                sortorder: "asc",//排序方式,可选desc,asc
                viewrecords: true,
                gridComplete:function () {
                    $('button.cancel').click(function () {
                        let rowid = $("#optionCompact-list").jqGrid("getGridParam", "selrow")//所选择的行id
                        $("#optionCompact-list").jqGrid('delGridRow', rowid,{
                            left: 800,
                            top: 400,
                            caption: "撤销操作",
                            msg: "你确定要撤销此操作?",
        ...
        $(window).resize(function () {//表格自适应屏幕
            $("#optionCompact-list").setGridWidth($("#compact-cart").width() - 10)
        });
    }
    ...
    render() {
        return (
            <div className="compact">
                ...
                <div id="compact-cart">
                    <table id="optionCompact-list"  className="option-record"></table>
                    <div id="optionCompact-page"></div>
                </div>
            </div>
        )
    }
